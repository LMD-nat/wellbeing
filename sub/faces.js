...
var facestrial = {
    ...
    labels: ['Caucasian', 'Middle-Eastern'],
    prompt: "<p>Please rate this face based on geographic location?</p>",
    max: 9,
    min: 1,
    step: 0.1,
    start: 5,
...
"<p>For the next part of the experiment, you will see a series of faces. Please rate them as honestly as possible based on where you think they are from, geographically. </p>" +
"<p>To do so, you will use a slider at the bottom of the screen. Slide it fully to the left if you think the person depicted is completely Caucasian. Slide it fully to the right if you think they are fully Middle-Eastern. </p>" +
"<p>You can also slide the pointer to anywhere in the middle of these two to indicate that you think someone is somewhere between Caucasian and Middle-Eastern (i.e., mixed).</p>",

"<p>If you prefer not to answer for a given face, simply press continue without moving the slider.</p>",
