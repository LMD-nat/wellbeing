...
var CAARS = {
  type: 'survey-likert',
  questions: [
    {prompt: "I like to be doing active things.", name:'caars_01', labels: caars, required:true},
    {prompt: "I lose things necessary for active tasks or activities (e.g., to-do lists, pencils, books, or tools).", name:'caars_02', labels: caars, required:true},
    {prompt: "I don\'t plan ahead.", name:'caars_03', labels: caars, required:true},
    {prompt: "I blurt out things.", name:'caars_04', labels: caars, required:true},
    {prompt: "I am a risk-taker or a daredevil.", name:'caars_05', labels: caars, required:true},
    {prompt: "I get down on myself.", name:'caars_06', labels: caars, required:true},
    {prompt: "I don\'t finish things I start.", name:'caars_07', labels: caars, required:true},
    {prompt: "I am easily frustrated.", name:'caars_08', labels: caars, required:true},
    {prompt: "I talk too much.", name:'caars_09', labels: caars, required:true},
    {prompt: "I am always on the go, as if driven by a motor.", name:'caars_10', labels: caars, required:true},
    {prompt: "I\'m disorganised.", name:'caars_11', labels: caars, required:true},
    {prompt: "I say things without thinking.", name:'caars_12', labels: caars, required:true},
    {prompt: "It\'s hard for me to stay in one place very long.", name:'caars_13', labels: caars, required:true},
    {prompt: "I have trouble doing leisure activities quietly.", name:'caars_14', labels: caars, required:true},
    {prompt: "I\'m not sure of myself.", name:'caars_15', labels: caars, required:true},
    {prompt: "It\'s hard for me to keep track of several things at once.", name:'caars_16', labels: caars, required:true},
    {prompt: "I\'m always moving, even when I should be still.", name:'caars_17', labels: caars, required:true},
    {prompt: "I forget to remember things.", name:'caars_18', labels: caars, required:true},
    {prompt: "I have a short fuse/hot temper.", name:'caars_19', labels: caars, required:true},
    {prompt: "I\'m bored easily.", name:'caars_20', labels: caars, required:true},
    {prompt: "I leave my seat when I am not supposed to.", name:'caars_21', labels: caars, required:true},
    {prompt: "I have trouble waiting in line or taking turns with others.", name:'caars_22', labels: caars, required:true},
    {prompt: "I still throw tantrums.", name:'caars_23', labels: caars, required:true},
    {prompt: "I have trouble keeping my attention focused when working.", name:'caars_24', labels: caars, required:true},
    {prompt: "I seek out fast-paced, exciting activities.", name:'caars_25', labels: caars, required:true},
    {prompt: "I avoid new challenges because I lack faith in my abilities.", name:'caars_26', labels: caars, required:true},
    {prompt: "I feel restless inside even if I am sitting still.", name:'caars_27', labels: caars, required:true},
    {prompt: "Things I hear or see distract me from what I\'m doing.", name:'caars_28', labels: caars, required:true},
    {prompt: "I am forgetful in my daily activities.", name:'caars_29', labels: caars, required:true},
    {prompt: "Many things set me off easily.", name:'caars_30', labels: caars, required:true},
    {prompt: "I dislike quiet, introspective activities.", name:'caars_31', labels: caars, required:true},
    {prompt: "I lose things that I need.", name:'caars_32', labels: caars, required:true},
    {prompt: "I have trouble listening to what other people are saying.", name:'caars_33', labels: caars, required:true},
    {prompt: "I am an underachiever.", name:'caars_34', labels: caars, required:true},
    {prompt: "I interrupt others when talking.", name:'caars_35', labels: caars, required:true},
    {prompt: "I change plans/jobs midstream.", name:'caars_36', labels: caars, required:true},
    {prompt: "I act okay on the outside, but on the inside I\'m unsure of myself.", name:'caars_37', labels: caars, required:true},
    {prompt: "I am always on the go.", name:'caars_38', labels: caars, required:true},
    {prompt: "I make comments/remarks that I wish I could take back.", name:'caars_39', labels: caars, required:true},
    {prompt: "I can\'t get things done unless there\'s an absolute deadline.", name:'caars_40', labels: caars, required:true},
    {prompt: "I fidget (with my hands or feet) or squirm in my chair.", name:'caars_41', labels: caars, required:true},
    {prompt: "I make careless mistakes or have trouble paying close attention to detail.", name:'caars_42', labels: caars, required:true},
    {prompt: "I step on people\'s toes without meaning to.", name:'caars_43', labels: caars, required:true},
    {prompt: "I have trouble getting started on a task.", name:'caars_44', labels: caars, required:true},
    {prompt: "I intrude on others\' activities.", name:'caars_45', labels: caars, required:true},
    {prompt: "It takes a great deal of effort for me to sit still.", name:'caars_46', labels: caars, required:true},
    {prompt: "My moods are unpredictable.", name:'caars_47', labels: caars, required:true},
    {prompt: "I don\'t like homework or job activities where I have to think a lot.", name:'caars_48', labels: caars, required:true},
    {prompt: "I\'m absent-minded in daily activities.", name:'caars_49', labels: caars, required:true},
    {prompt: "I am restless or overactive.", name:'caars_50', labels: caars, required:true},
    {prompt: "I depend on others to keep my life in order and attend to the details.", name:'caars_51', labels: caars, required:true},
    {prompt: "I annoy other people without meaning to.", name:'caars_52', labels: caars, required:true},
    {prompt: "Sometimes my attention narrows so much that I\'m oblivious to everything else; other times it\'s so broad that everything distracts me.", name:'caars_53', labels: caars, required:true},
    {prompt: "I tend to squirm or fidget.", name:'caars_54', labels: caars, required:true},
    {prompt: "I can\'t keep my mind on something unless it\'s really interesting.", name:'caars_55', labels: caars, required:true},
    {prompt: "I wish I had greater confidence in my abilities.", name:'caars_56', labels: caars, required:true},
    {prompt: "I can\'t sit still very long.", name:'caars_57', labels: caars, required:true},
    {prompt: "I give answers to questions before the questions have been completed.", name:'caars_58', labels: caars, required:true},
    {prompt: "I like to be up and on the go rather than being in one place.", name:'caars_59', labels: caars, required:true},
    {prompt: "I have trouble finishing job tasks or homework.", name:'caars_60', labels: caars, required:true},
    {prompt: "I am irritable.", name:'caars_61', labels: caars, required:true},
    {prompt: "I interrupt others when they are working or playing.", name:'caars_62', labels: caars, required:true},
    {prompt: "My past failures make it hard for me to believe in myself.", name:'caars_63', labels: caars, required:true},
    {prompt: "I am distracted when things are going on around me.", name:'caars_64', labels: caars, required:true},
    {prompt: "I have problems organising my tasks and activities.", name:'caars_65', labels: caars, required:true},
    {prompt: "I misjudge how long it takes to do something or go somewhere.", name:'caars_66', labels: caars, required:true}
      ],
